...
def parse_receipt(request: Request, file: UploadFile = File(...)):
    ...
    receipt_extraction = parse_receipt_image(prepared_bytes, content_type=prepared_type, request=request)
